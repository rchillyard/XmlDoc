...
//
//import com.phasmidsoftware.xmldoc.core.{Text, XmlException}
...
//    }
////
////    case class StyleMap(Pairs: Seq[CharSequence])(val styleSelectorData: StyleSelectorData) extends StyleSelector
////
...
//    }
//
//    case class Simple($: CharSequence)(val superObject: Base)
//
...
//                }
//            //                val wy = TryUsing(StateR())(sr => KmlRenderers.rendererGeometrys.render(gs, FormatXML(), sr))
...
//    }
//
//    it should "extract small Folder 2" in {
//        val xml = <xml>
//            <Folder>
//                <name>Untitled layer</name>
//                <Placemark>
...
//                                placemark.featureData.maybeDescription shouldBe Some(Text("\n                        K405<br>RDK1: 51B\n                    ".stripMargin))
//                                val ls: scala.Seq[Geometry] = placemark.Geometry
//                                ls.size shouldBe 1
//                                val geometry: Geometry = ls.head
//                                val coordinates: scala.Seq[Coordinates] = geometry match {
