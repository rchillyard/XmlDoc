# 05-move-move-divergent

## Purpose

Both sides move the same node. This fixture is expected to **conflict**: Report move-move.
...
2. Reopen the base and perform the left operation: Move r1 to the top.
3. Save/export that branch as `left.idml`, then close it.
4. Reopen the unchanged base and perform the right operation: Move r1 to the bottom.
