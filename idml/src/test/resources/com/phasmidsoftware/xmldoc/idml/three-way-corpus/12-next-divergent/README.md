...
Divergent NextTextFrame references. This fixture is expected to **conflict**: Report reference-divergence.
...
2. Reopen the base and perform the left operation: Set tf1.NextTextFrame=tfA.
3. Save/export that branch as `left.idml`, then close it.
4. Reopen the unchanged base and perform the right operation: Set tf1.NextTextFrame=tfB.
