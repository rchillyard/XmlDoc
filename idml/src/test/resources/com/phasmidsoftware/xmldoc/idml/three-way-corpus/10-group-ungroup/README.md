...
Group/ungroup and child movement. This fixture is expected to **conflict**: Report structural-parent-change.
...
2. Reopen the base and perform the left operation: Ungroup g1.
3. Save/export that branch as `left.idml`, then close it.
4. Reopen the unchanged base and perform the right operation: Move child r3 inside g1.
