...
Cross-node reference insertion. This fixture is expected to **accept**: Accept and update reciprocal references.
...
2. Reopen the base and perform the left operation: Insert tfX between tf1 and tf2.
