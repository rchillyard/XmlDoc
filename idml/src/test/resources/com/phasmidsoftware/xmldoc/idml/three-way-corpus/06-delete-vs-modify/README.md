...
One side deletes; the other modifies. This fixture is expected to **conflict**: Report delete-modify.
...
2. Reopen the base and perform the left operation: Delete r2.
3. Save/export that branch as `left.idml`, then close it.
4. Reopen the unchanged base and perform the right operation: Change r2 fill to red.
