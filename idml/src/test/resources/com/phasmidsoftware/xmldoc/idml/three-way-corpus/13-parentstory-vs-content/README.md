# 13-parentstory-vs-content

## Purpose

ParentStory reference versus story content. This fixture is expected to **conflict**: Report reference-divergence.
...
2. Reopen the base and perform the left operation: Set tf2.ParentStory=story2 and detach it from tf1.
3. Save/export that branch as `left.idml`, then close it.
4. Reopen the unchanged base and perform the right operation: Edit story1 content that previously flowed into tf2.
