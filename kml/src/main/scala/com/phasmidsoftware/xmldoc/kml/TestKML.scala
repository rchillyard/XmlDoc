...
import com.phasmidsoftware.xmldoc.core.FP.tryNotNull
import com.phasmidsoftware.xmldoc.kml.KMLCompanion.renderKMLToPrintStream
import com.phasmidsoftware.xmldoc.render.{Format, FormatText}
